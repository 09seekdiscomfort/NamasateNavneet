...
const RestaurantCard = (props) => {
    const { name, costForTwo, cloudinaryImageId, id, avgRating, cuisines } =
        props.dynamicData.info
        ...
        <div className="restaurantCard m-4 w-[16rem] shadow-2xl min-h-[26rem] rounded-xl transition-transform transform scale-100 hover:scale-90">
            <div className="imageRestaurant">
                <img
                    ...
                    className="restImage w-[30rem] h-[12rem] object-cover rounded-3xl p-4"
                ></img>
            </div>
            <div className="rst-txt min-h-28 m-4">
                <h3 className="resturantName text-xl font-semibold mt-4 line-clamp-1">
                    {name}
                </h3>
                ...
                <h4 className="cusines line-clamp-1 mt-4">
                    {cuisines.join(', ')}
                </h4>
